...
#include "ros2_cpp_pkg/srv/detail/odd_even_check__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ros2_cpp_pkg
cdr_serialize(
  const ros2_cpp_pkg::srv::OddEvenCheck_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_cpp_pkg::srv::OddEvenCheck_Request & ros_message)
{
  // Member: number
  cdr >> ros_message.number;
...
{
  auto typed_message =
    static_cast<const ros2_cpp_pkg::srv::OddEvenCheck_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_cpp_pkg::srv::OddEvenCheck_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_ros2_cpp_pkg
const rosidl_message_type_support_t *
get_message_type_support_handle<ros2_cpp_pkg::srv::OddEvenCheck_Request>()
{
  return &ros2_cpp_pkg::srv::typesupport_fastrtps_cpp::_OddEvenCheck_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_cpp_pkg, srv, OddEvenCheck_Request)() {
  return &ros2_cpp_pkg::srv::typesupport_fastrtps_cpp::_OddEvenCheck_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ros2_cpp_pkg
cdr_serialize(
  const ros2_cpp_pkg::srv::OddEvenCheck_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: decision
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_cpp_pkg::srv::OddEvenCheck_Response & ros_message)
{
  // Member: decision
  cdr >> ros_message.decision;
...
{
  auto typed_message =
    static_cast<const ros2_cpp_pkg::srv::OddEvenCheck_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ros2_cpp_pkg::srv::OddEvenCheck_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ros2_cpp_pkg::srv::typesupport_fastrtps_cpp::_OddEvenCheck_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_cpp_pkg, srv, OddEvenCheck_Response)() {
  return &ros2_cpp_pkg::srv::typesupport_fastrtps_cpp::_OddEvenCheck_Response__handle;
}
...
{
  return &ros2_cpp_pkg::srv::typesupport_fastrtps_cpp::_OddEvenCheck__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_cpp_pkg, srv, OddEvenCheck)() {
  return &ros2_cpp_pkg::srv::typesupport_fastrtps_cpp::_OddEvenCheck__handle;
}
